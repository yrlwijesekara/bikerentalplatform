...
import { getUserProfile, updateUserProfile, updateVendorApproval } from "../controllers/usercontroller.js";
...
router.put("/vendor/:id/approval", authenticateToken, updateVendorApproval);
